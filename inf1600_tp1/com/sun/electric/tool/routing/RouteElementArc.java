...
//						headNi.modifyInstance(0, 0, autoGrowth.getLambdaFullWidth(), autoGrowth.getHeight(), 0);
                                                // we want to scale the node without notifying it,
                                                // otherwise the router wants to wrongly scale the position of all connection.
                                                // It's now checked in LayoutCell.transformByPort
//                                                ImmutableNodeInst d = headNi.getD();
//                                                headNi.lowLevelModify(d.withSize(EPoint.fromLambda(
//                                                        d.size.getLambdaX() + autoGrowth.getWidth(),
//                                                        d.size.getLambdaY() + autoGrowth.getHeight())));                                            
					}
				}
			}
...
//						tailNi.modifyInstance(0, 0, autoGrowth.getLambdaFullWidth(), autoGrowth.getHeight(), 0);
                                                ...
                                                // otherwise the router wants to wrongly scale the position of all connection.
                                                // It's now checked in LayoutCell.transformByPort
//                                                ImmutableNodeInst d = tailNi.getD();
//                                                tailNi.lowLevelModify(d.withSize(EPoint.fromLambda(
//                                                        d.size.getLambdaX() + autoGrowth.getWidth(),
//                                                        d.size.getLambdaY() + autoGrowth.getHeight())));                                            
					}
				}
            ...
            if (headPoint.equals(tailPoint))
                thisWidth = arcProto.getDefaultLambdaBaseWidth();
