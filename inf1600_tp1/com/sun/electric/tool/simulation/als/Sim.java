...
//	private Load       chekRoot;
	...
	private boolean fireEvent()
	{
		...
		switch (linkHead.type)
		{
			case 'G':
				...
				{
					operatr -= 128;
					ALS.Node nodeHead = (ALS.Node)linkHead.state; //FRB: why were these lines in comments?
	...
	private void createCheckList(ALS.Node nodeHead, ALS.Link linkHead)
	{
		...
		{
                        // I think a node with nothing driving it, should be displayed as old value attenuated (OFF_STRENGTH is displayed very attenuated)
