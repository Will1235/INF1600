...
import javax.swing.JOptionPane; // **moi
...
public class Progress
{
	 ...
	 */
	public void close()
	throws InterruptedException // **moi
	{
		...
		if (TopLevel.isMDIMode())
		{
			...
			xPos = pt.x;
			yPos = pt.y;
			while(!jif.isVisible()) { /*JOptionPane.showMessageDialog(null, "MDI", "alert " + xPos + "," + yPos, JOptionPane.ERROR_MESSAGE);*/ Thread.sleep(100); } // **moi
            TopLevel.removeFromDesktop(jif);
			// while(jif.isVisible()) { jif.setVisible(false); Thread.sleep(10); } // **moi
			jif.dispose();
//JOptionPane.showMessageDialog(null, "MDI", "alert " + xPos + "," + yPos, JOptionPane.ERROR_MESSAGE); // **moi
		} else
		{
			...
			jf.setVisible(false);
			jf.dispose();
//JOptionPane.showMessageDialog(null, "nonMDI", "alert", JOptionPane.ERROR_MESSAGE); // **moi
		}	
	}
